        ...
        case 'POP_TO':
          {
            ...
            if (id !== undefined) {
              for (let i = currentIndex; i >= 0; i--) {
                ...
                if (route.name === action.payload.name && id === getId?.({
                  params: route.params
                })) {
                  index = i;
                  break;
        ...
        case 'PRELOAD':
          {
            ...
            const preloadedRoute = state.preloadedRoutes.findLast(route => route.name === action.payload.name && id === getId?.({
              params: route.params
            }));
            if (preloadedRoute) {
              return {
                ...state,
                preloadedRoutes: state.preloadedRoutes.map(route => route.key === preloadedRoute.key ? {
                  ...route,
                  params
                } : route)
              };
            ...
            return {
              ...state,
              preloadedRoutes: state.preloadedRoutes.concat(createRouteFromAction({
                action,
                routeParamList
              }))
            };
